function [R_squeare_real_axial,R_squeare_real_later,k_axial,k_lateral, k_1d, R_squeare_real_1d] = test_reverb_cf_fast(M_filtered,res_x,res_y,mode,correc,y_v, x_v)
% function [R_squeare_real_axial,R_squeare_real_later,k_axial,k_lateral, k_1d, R_squeare_real_1d] = test_reverb_cf_fast(M_filtered,res_x,res_y,mode,correc,y_v, x_v)
    if mode==1
    ...
    x_v2 = x_v(loc1(1):loc1(2));
    R_cc_1d_cut = R_cc_1d(loc1(1):loc1(2));
    ...
    [fitresult3, gof3] = createFit_atenuation_1d_RSWE (x_v2, R_cc_1d_cut);
